...
<head>
  ...
  <title>Calista | Mot de passe oublié</title>
          ...
          <div class="card-body text-center p-4 p-sm-5">
            ...
            <form class="mt-4" method="post" action="">
              <div class="form-floating mb-3">
                <input type="email" class="form-control valid-input" name="mail" id="mail" placeholder="Adresse e-mail associée à mon compte" required>
                <label for="mail">Adresse e-mail</label>
              </div>
              <div class="d-grid">
                <button class="btn btn-orange fw-bold" type="submit">Réinitialiser le mot de passe</button>
              </div>
